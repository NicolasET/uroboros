...
7. **BLOCKING — settle the reviewer's model/effort per the Model/effort protocol.** Do not dispatch the reviewer anywhere in the run before this is settled.
